...
\begin{equation}
\mathbf{X}(\omega) = \begin{bmatrix} X_1(\omega) \ X_2(\omega) \ \vdots \ X_n(\omega) \end{bmatrix}
\end{equation}

It allows us to bundle multiple characteristics of a single experiment into a single mathematical object:
\begin{equation}
