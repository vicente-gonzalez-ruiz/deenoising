...
An example of a random variable is the The 10-Minutes Bus
...
and $x\in\mathbb{R}$ is such number. Obviously $X$ is measurable,
because we can compute, for example, $P(X\leq 5)$. This is an example
...
\begin{itemize}
\item Example (continuous input): Let's consider again the 10-Minute
