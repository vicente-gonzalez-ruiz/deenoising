...
\begin{equation}
  y = \text{GAT}(x)=\frac{2}{\gamma}\sqrt{\gammax+\frac{3}{8}\gamma^2+\sigma^2},
\end{equation}
where now
\begin{equation}
...
not preserved (the result is biased), in neither of the directions of the transform. This
basically implies that you cannot recover the original mean by simply
