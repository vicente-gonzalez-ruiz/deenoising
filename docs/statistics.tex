...
$1$. It consists of converting the realizations using 
\begin{equation}
  y = \text{GAT}(\hat{x)=\frac{2}{\gamma}\sqrt{\gamma\hat{x+\frac{3}{8}\gamma^2+\sigma^2},
\end{equation}
where now
\begin{equation}
...
\begin{equation}
  \hat{\mathbf{s}}_ \approx \frac{1}{4}y^2-\frac{1}{4}\left(1+\frac{8\sigma^2}{y^2} + \frac{1}{32}\left(\frac{i+\frac{8\sigma^2}{y^2}}{y^2}\right)\right).
\end{equation}
