...
\section{\glsentryfull{LLN}} % Law Large Numbers
%{{{
...
an uniform distribution $\mathcal{U}(a,b)$. Formally, each
$\bm{x}_i\in\mathcal{X}$, being $\mathcal{X}$ the realization space of
the \gls{DRV} $X\sim\mathcal{U}(a,b)$.
