% Podemos comparar cómo mejora la resolución (curva FSC) para cuantificar el denoising?
...
\begin{figure}[h]
  \centering
  \href{https://github.com/vicente-gonzalez-ruiz/deenoising/blob/main/docs/GF/empiar10311_stack_crop/denoise.ipynb}{\includegraphics[width=1.0\textwidth]{~/gdrive_TomogramDenoising/deenoising/docs/GF/empiar10311_stack_crop/denoised.pdf}}
  \caption{Denoising of EMPIAR-10311 (see Fig.~\ref{fig:empiar10311}) using
    \gls{GF}.\label{fig:GF_empiar10311}}
\end{figure}

\begin{figure}[h]
  \centering
  \href{https://github.com/vicente-gonzalez-ruiz/deenoising/blob/main/docs/GF/empiar11415/denoise.ipynb}{\includegraphics[width=1.0\textwidth]{~/gdrive_TomogramDenoising/deenoising/docs/GF/empiar11415/denoised.pdf}}
  \caption{Denoising of EMPIAR-11415 (see Fig.~\ref{fig:empiar11415}) using
    \gls{GF}.\label{fig:GF_empiar11415}}
\end{figure}

\begin{figure}[h]
  \centering
  \href{https://github.com/vicente-gonzalez-ruiz/deenoising/blob/main/docs/GF/Corbel2301_block2_June2019_crop_june2024_ali_crop/denoise.ipynb}{\includegraphics[width=1.0\textwidth]{~/gdrive_TomogramDenoising/deenoising/docs/GF/Corbel2301_block2_June2019_crop_ali_crop/denoised.pdf}}
  \caption{Denoising of Corbel Small (see Fig.~\ref{fig:corbel_small}) using
    \gls{GF}.\label{fig:GF_corbel_small}}
\end{figure}

\begin{figure}
  \centering
  \href{https://github.com/vicente-gonzalez-ruiz/denoising/blob/main/docs/GF/epfl1_subset1_float/denoise.ipynb}{\includegraphics[width=1.0\textwidth]{~/gdrive_TomogramDenoising/deenoising/docs/GF/epfl1_subset1_float/denoised.pdf}}
  \caption{Denoising of EPFL 1 Subset 1 (see
    Fig.~\ref{fig:epfl1_subset1_float}) using
    GF.\label{fig:GF_epfl1}}
\end{figure}
