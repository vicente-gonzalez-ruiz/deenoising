...
Uniform quantizers are only optimal if the input samples follow an
uniform distribution. In we know, a priori, that actual statistical
distribution, the QSS can be different over the dynamic range of the
input signal $\mathbf{x}$.
