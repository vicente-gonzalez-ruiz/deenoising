...
Discrete signal are (a priori, infinite) sequences of samples. For
example, if $x(t)$ is a analog signal that depends on time, the $n$-th
signal sample is defined by
\begin{equation}
