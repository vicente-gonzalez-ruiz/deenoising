...
Noise can be stochastic (i.d.d., independent and identically
distributed), such as Poisson or Gaussian, or structured (correlated).
Structured corruptions exhibit correlations along dominant
orientations and patterns that are coherent spatially, temporally, or
otherwise. % https://arxiv.org/pdf/2510.01666
