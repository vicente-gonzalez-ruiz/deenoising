...
\item \textbf{Algorithm-driven methods}: when their applicability
  ...
  signal-domain/frequency filtering methods such as Gaussian and
  Wiener denoisers, Variational / Optimization Methods, and
  signal-averaing methods such as \gls{NLM} and \gls{BM3D}.
\item \textbf{Data-driven methods}: if the denoiser, although there is
  a list of computational steps, they must learn from the data to
