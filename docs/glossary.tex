...
\newacronym{LRM}{LRM}{Low-Radiation Microscopy}
...
\newacronym{DRVec}{DRVec}{Discrete Random Vector}
...
\newacronym{SRV}{SRV}{Stochastic Random Variable}
...
\newacronym{CARE}{CARE}{Content-Aware (image) REstoration}
\newacronym{N2C}{N2C}{Noise to Clean}
\newacronym{N2N}{N2N}{Noise to Noise}
\newacronym{Nei2Nei}{Nei2Nei}{Neighbor to Neighbor}
