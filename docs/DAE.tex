...
\begin{figure}[t]
  \centering
  \href{https://github.com/vicente-gonzalez-ruiz/denoising/blob/main/docs/DAE/cryoCARE/corbel_small/denoise_even_odd.ipynb}{\includegraphics[width=1.0\textwidth]{~/gdrive_tomomgram_denoising/tmp/corbel_small__denoised__cryoCARE_even_odd.pdf}}
...
\begin{figure}[t]
  \centering
  \href{https://github.com/vicente-gonzalez-ruiz/denoising/blob/main/docs/DAE/cryoCARE/corbel_small/denoise_odd_and_even_registered.ipynb}{\includegraphics[width=1.0\textwidth]{~/gdrive_tomomgram_denoising/tmp/corbel_small__denoised__cryoCARE_even_odd_registered.pdf}}
...
\begin{figure}[t]
  \centering
  \href{https://github.com/vicente-gonzalez-ruiz/denoising/blob/main/docs/DAE/cryoCARE/epfl1/denoise_even_odd.ipynb}{\includegraphics[width=1.0\textwidth]{~/gdrive_tomomgram_denoising/tmp/epfl1_subset1_float__denoised__cryoCARE_even_odd.pdf}}
...
\begin{figure}[t]
  \centering
  \href{https://github.com/vicente-gonzalez-ruiz/denoising/blob/main/docs/DAE/cryoCARE/epfl1/denoise_odd_and_even_registered.ipynb}{\includegraphics[width=1.0\textwidth]{~/gdrive_tomomgram_denoising/tmp/epfl1_subset1_float__denoised__cryoCARE_even_odd_registered.pdf}}
